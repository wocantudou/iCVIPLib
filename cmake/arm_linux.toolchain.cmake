...
set(LAJI_DEV ON)
if (LAJI_DEV)
    set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -pthread -fPIC -O2 -ftree-vectorize -pipe -no-canonical-prefixes -march=armv7-a")
    set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} ${CPP11} -pthread -fpermissive -fPIC -O2 -ftree-vectorize -pipe -no-canonical-prefixes -march=armv7-a")
else()
    set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -pthread -fPIC -O2 -ftree-vectorize -pipe -no-canonical-prefixes -march=armv7-a -mfloat-abi=softfp -marm -mfpu=neon")
    set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} ${CPP11} -pthread -fpermissive -fPIC -O2 -ftree-vectorize -pipe -no-canonical-prefixes -march=armv7-a -mfloat-abi=softfp -marm -mfpu=neon")
endif()	
