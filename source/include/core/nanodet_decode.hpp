...
class iCVNanodetDecode {
  ...
  private:
    ...
    BoxInfo disPred2Bbox(int input_h, int input_w, const float *&dfl_det,
  ...
  public:
    void decode_infer(int input_h, int input_w,
        ...
        for (int idx = 0; idx < feature_h * feature_w; idx++) {
            ...
            if (score > threshold) {
                ...
                results[cur_label].push_back(
                    disPred2Bbox(input_h, input_w, bbox_pred, cur_label, score,
                                 col, row, stride));
            }
        }
    }
...
#define iCVNanodetDecodeClass ICV_SAFE_OPENCV::iCVNanodetDecode
#define iCVNanodetDecodeInst ICVSingletonClass<iCVNanodetDecodeClass>::get_inst
